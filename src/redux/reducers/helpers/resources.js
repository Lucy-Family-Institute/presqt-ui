 ...
 **/
export default function buildResourceHierarchy(side, state, data) {
  const selectedResource = side === 'left' ? state.selectedLeftResource : state.selectedRightResource;
  const openResources = side === 'left' ? state.openLeftResources : state.openRightResources;
