...
export const actionCreators = createActions({
  ...
  RESOURCES: {
    ...
    CANCEL_DOWNLOAD: (ticketNumber, targetToken) => ({
      ticketNumber,
      targetToken
    }),
    ...
    CANCEL_UPLOAD: (ticketNumber, targetToken) => ({
      ticketNumber,
      targetToken
    }),
